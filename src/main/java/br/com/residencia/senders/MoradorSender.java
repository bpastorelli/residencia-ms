...
public class MoradorSender {
	...
	public GETMoradoresSemResidenciaResponseDto buscarPorResidenciaId(MoradorRequestDto request) throws IllegalArgumentException, IllegalAccessException, ClassNotFoundException{
